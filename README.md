...
| `--ignore-include-blocks`    | When true, includes found in `include` blocks will be ignored                                                                                                      | false             |
...
```bash
go install github.com/transcend-io/terragrunt-atlantis-config@v1.15.0
```
